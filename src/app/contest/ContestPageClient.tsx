        ...
        <div className="max-w-6xl mx-auto flex flex-col sm:flex-row justify-between items-start sm:items-center gap-4">
          ...
          <div className="flex flex-wrap items-center gap-3">
            <a
              ...
              className="inline-flex items-center gap-2 px-4 py-2 border border-[#0ae448]/40 hover:border-[#0ae448] hover:bg-[#0ae448]/10 text-xs font-['Space_Mono',monospace] uppercase text-[#0ae448] transition-colors rounded-none"
              title="Open HaXtreme 5.0 Hacker Guide (PDF)"
            >
              <svg className="w-3.5 h-3.5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                <path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M12 6.253v13m0-13C10.832 5.477 9.246 5 7.5 5S4.168 5.477 3 6.253v13C4.168 18.477 5.754 18 7.5 18s3.332.477 4.5 1.253m0-13C13.168 5.477 14.754 5 16.5 5c1.747 0 3.332.477 4.5 1.253v13C19.832 18.477 18.247 18 16.5 18c-1.746 0-3.332.477-4.5 1.253" />
              </svg>
              <span>Hacker Guide (PDF)</span>
            </a>
